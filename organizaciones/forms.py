...
class FormularioRegisterOrgSocial(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['fk_tipo_organizacion'].empty_label = 'Seleccione el Tipo De Organizacion'
        self.fields['fk_tipo_organizacion'].widget.attrs.update({'class': 'form-control'})
        self.fields['fk_tipo_organizacion'].label= 'Tipo de Organizacion'
        self.fields['codigo'].widget.attrs.update({'class': 'form-control',
                                                   'placeholder': 'Codigo de la Organizacion Social'})
        ...
        self.fields['nombre'].widget.attrs.update({'class': 'form-control',
                                                   'placeholder': 'Nombre de la Organizacion Social'})
        self.fields['email'].widget.attrs.update({'class': 'form-control',
                                                   'placeholder': 'Email de la Organizacion Social'})
        self.fields['fecha_conformacion'].widget.attrs.update(
                                            {'class': 'form-control',
                                             'placeholder':
                                             'Fecha de Conformacion',
                                             'readonly':
                                             'readonly'})
        self.fields['sector'].widget.attrs.update({'class': 'form-control',
                                                   'placeholder': 'Sector de la Organizacion Social'})
        ...
        self.fields['activa'].widget.attrs.update({'class': 'form-control',
                                                   ...
                                                   'data-off': 'No',
                                                   'checked': 'checked'})
        self.fields['activa'].label = "¿La Organizacion se encuentra Activa?"
