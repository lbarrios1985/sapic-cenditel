function cargar_organizciones(fk_tipo, url)
    {
        if(fk_tipo!='')
        {
            ...
            $.ajax({
                ...
                {
                    $('#id_fk_org_social').html('<option value="">Cargando...</option>');
                },
                success: function(data) {
                    ...
                    $('#id_fk_org_social').html(options);
                    $("#id_fk_org_social option:first").attr('selected', 'selected');
                }
            });
        }
        else
        {
             $('#id_fk_org_social').html('<option value="">Seleccione Organizacion Social</option>');
        }
    };
